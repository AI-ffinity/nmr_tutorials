...
> **Caution** Not everything is thoroughly tested yet
{: .admonition .caution}
...
> **Important:** Always set the `SI` to the next or higher power of 2, never lower than the respective `TD` value!
...
> **Tip:** **NUS and LP should not be combined.** NUS simulates fitfully the whole FID, while LP simulates
...
> **Tip:** Those values may be obtained manually: in the 1D or 2D spectrum, note the "col Index" (`16` on the screenshot). Save
...
> Linear Prediction in the F1 (C) and F3 (N) dimensions is not recommended with this PP. In my experience it introduces noise.
{: .admonition .important}
