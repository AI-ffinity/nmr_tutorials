...
selected `PHC0` value to the `N-HN plane` spectrum. 
...
I couldn't find a plane containing peaks of dispersion character, but you got the point.
...
13. **Extract and Process a Specific Plane:**
  ...
  - A window will ask for the **plane number** (displayed at the bottom left in red letters). Enter a **Destination PROCNO**,
e.g. `23265`.
